//boilerplate
// create constants for game states and intialize game state
...
//DECLARE SCORE VARIABLES AND GAMEOVER AND RESTART VARIABLES
...
function preload(){
  ...
  //load animation for game over and restart
...
function setup() {
  ...
  //create restart sprite add image, scale it and make it visible false
